...
public class Outline : MonoBehaviour {
    ...
    {
        get { return SelectionManager.Instance.outlineColor; }
        set
        {
            SelectionManager.Instance.outlineColor = value;
            needsUpdate = true;
        }
    }
    ...
    void UpdateMaterialProperties()
    {
        ...
        outlineFillMaterial.SetColor("_OutlineColor", SelectionManager.Instance.outlineColor);
